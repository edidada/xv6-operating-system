...
# Assemble kernel .S files with the same flags as C files to avoid PIE/GOT sequences.
$K/%.o: $K/%.S
	$(CC) $(CFLAGS) -c -o $@ $<
...
QEMUOPTS = -machine virt,aclint=off -bios none -kernel $K/kernel -m 128M -smp $(CPUS) -nographic
